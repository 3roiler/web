...
export function BlogPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-24" id="top">
      <Seo
        title="Blog"
        description="Gedanken & Notizen zu Backend, Infrastruktur und Homelab von Paul Wechselberger."
      />
      <div className="mx-auto max-w-4xl px-6 sm:px-10 lg:px-16 pt-16">
        ...
        <div className="mt-16 space-y-8">
          ...
          {posts?.map((post) => (
            <article
              key={post.id}
              className="group rounded-3xl border border-white/10 bg-white/5 p-8 transition hover:-translate-y-0.5 hover:border-cyan-400/40"
            >
